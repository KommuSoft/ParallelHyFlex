...
public class UtilsTest {
    ...
    public void ceiling2Log2() {
        for (int i = 1; i < 31; i++) {
            ...
            for(int j = 1<<(i-1); j < k; j++) {
                Assert.assertEquals(Utils.ceiling2Log(j),i);
            }
        }
    }
    ...
    public void priority2Log2() {
        for (int i = 1; i < 31; i++) {
            int k = 1 << i;
            for(int j = 1<<(i-1); j < k; j++) {
                Assert.assertEquals(""+j,Utils.ceiling2Log(j),i-1);
            }
        }
    }
    ...
    public void testNext2Pow() {
        for (int i = 0; i < 31; i++) {
            int k = 1 << (1+i);
            for(int j = 1<<i; j < k; j++) {
                Assert.assertEquals(Utils.next2Pow(j),k);
            }
        }
    }
    ...
    public void testBase2Pow() {
        for (int i = 0; i < 31; i++) {
            ...
            int l = 1<<i;
            for(int j = l; j < k; j++) {
                Assert.assertEquals(l,Utils.base2Pow(j));
            }
        }
    }
