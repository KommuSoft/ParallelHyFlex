 ...
 * @author kommusoft
 */
public class FrequencyAssignmentHeuristicL1Test extends ProblemHeuristicLTestBase<FrequencyAssignmentSolutionGenerator, FrequencyAssignmentProblem, FrequencyAssignmentProblemGenerator, FrequencyAssignmentSolution> {
    ...
    public LocalSearchHeuristicBase<FrequencyAssignmentSolution, FrequencyAssignmentProblem> renewHeuristic() {
        return new FrequencyAssignmentHeuristicL1(getTsp());
    }
