 ...
 * @author kommusoft
 */
public class ThreeSatHeuristicM1Test extends ProblemHeuristicMTestBase<ThreeSatSolutionGenerator,ThreeSatProblem,ThreeSatProblemGenerator,ThreeSatSolution> {
    ...
    public MutationHeuristicBase<ThreeSatSolution, ThreeSatProblem> renewHeuristic() {
        return new ThreeSatHeuristicM1(getTsp());
    }
