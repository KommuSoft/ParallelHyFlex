 ...
 * @author kommusoft
 */
public class ThreeSatHeuristicL2Test extends ProblemHeuristicLTestBase<ThreeSatSolutionGenerator,ThreeSatProblem,ThreeSatProblemGenerator,ThreeSatSolution> {
    ...
    public LocalSearchHeuristicBase<ThreeSatSolution, ThreeSatProblem> renewHeuristic() {
        return new ThreeSatHeuristicL2(getTsp());
    }
