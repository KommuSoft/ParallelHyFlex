...
import parallelhyflex.problems.threesat.heuristics.ThreeSatHeuristicM4;
 ...
 * @author kommusoft
 */
public class ThreeSatHeuristicM4Test extends ProblemHeuristicMTestBase<ThreeSatSolutionGenerator,ThreeSatProblem,ThreeSatProblemGenerator,ThreeSatSolution> {
    ...
    public MutationHeuristicBase<ThreeSatSolution, ThreeSatProblem> renewHeuristic() {
        return new ThreeSatHeuristicM4(getTsp());
    }
