 ...
 * @author kommusoft
 */
public class TwoSetSearchSpace<TSolution extends Solution<TSolution>, TProblem extends Problem<TSolution>> extends SearchSpaceBase<TSolution,TProblem> {
    
    private final ArrayList<EnforceableConstraint<TSolution>> positive = new ArrayList<>(), negative = new ArrayList<>();
    
    public TwoSetSearchSpace (TProblem problem) {
        super(problem);
    }
