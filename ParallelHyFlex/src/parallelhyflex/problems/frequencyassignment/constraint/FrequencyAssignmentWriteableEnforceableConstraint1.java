 ...
 * @author kommusoft
 */
public class FrequencyAssignmentWriteableEnforceableConstraint1 extends WriteableEnforceableConstraintBase<FrequencyAssignmentSolution, FrequencyAssignmentProblem> {

    private final Tuple2<Integer, Integer> data;

    public FrequencyAssignmentWriteableEnforceableConstraint1(Tuple2<Integer, Integer> data, FrequencyAssignmentProblem problem) {
        this(problem, data);
    }

    public FrequencyAssignmentWriteableEnforceableConstraint1(FrequencyAssignmentProblem problem, Tuple2<Integer, Integer> data) {
        super(problem);
        this.data = data;
    }
