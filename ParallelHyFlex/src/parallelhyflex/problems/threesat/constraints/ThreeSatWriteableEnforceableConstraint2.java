 ...
 * @author kommusoft
 */
public class ThreeSatWriteableEnforceableConstraint2 extends ThreeSatWriteableEnforceableConstraint {
     ...
     * @param maxDistance
     */
    public ThreeSatWriteableEnforceableConstraint2(ThreeSatProblem problem, ThreeSatSolution root, int maxDistance) {
        super(problem);
        this.root = root;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ThreeSatWriteableEnforceableConstraint2) {
            ThreeSatWriteableEnforceableConstraint2 ob = (ThreeSatWriteableEnforceableConstraint2) obj;
    ...
    private static final Logger LOG = Logger.getLogger(ThreeSatWriteableEnforceableConstraint2.class.getName());
}
