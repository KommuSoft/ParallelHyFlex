...
\begin{flushleft}
  ...
  \begin{tabularx}{\textwidth}{@{}p{22mm}X@{}}
    $\mathbb{B}$	& De set van Booleaanse waarden: $\mathbb{B}=\left\{\mbox{\textbf{true}},\mbox{\textbf{false}}\right\}$. \\
    $\mathbb{N}$	& De set van natuurlijke getallen: $\mathbb{N}=\left\{0,1,2,\ldots\right\}$ \\
    $E$   & Energie \\
    $m$   & Massa \\
    $\pi$ & Het getal pi \\
  \end{tabularx}
