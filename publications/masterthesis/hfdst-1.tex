...
\paragraph{}
Met deze definitie vallen twee methodologi\"en samen:
\begin{enumerate}
 \item De gebruiker stelt een set transitiefuncties ter beschikking. De hyperheuristiek past vervolgens een sequentie van deze functies toe op de populatie.
 \item Men stelt componenten ter beschikking die de hyperheuristiek zelf kan samenstellen tot transitiefuncties.
\end{enumerate}
