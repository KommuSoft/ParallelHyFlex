...
\section{Structuur}
In \chpref{defi} defini\"eren we het probleemdomein en de concepten hieromtrent. Bij de meeste aspecten wordt ook relevante literatuur besproken samen met de huidige stand van zaken.
...
\paragraph{}
We ontwikkelen een systeem genaamd \emph{ParHyFlex} in \chpref{parhyf}. Dit systeem ondersteund de bouw van parallelle hyperheuristieken en werd gebouwd op basis van de literatuurstudie in \chpref{defi} en de hypotheses die voortkomen uit \chpref{chesc}. Ook wordt een concrete hyperheuristiek uitgewerkt: \emph{ParAdapHH} is een parallelle variant van \emph{AdapHH}, de winnaar van de competitie die we in \chpref{chesc} beschouwen.
