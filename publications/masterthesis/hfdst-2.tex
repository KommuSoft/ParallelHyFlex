...
In 2010 publiceren \auth[5586064]{Burke et al.} een paper waarin ze \abhf{} voorstellen. \abhf{} is een klassenbibliotheek geschreven in \abjava{}. Het laat toe dat de gebruiker hyperheuristieken implementeert waardoor de prestaties uniform getest kunnen worden.
...
De wedstrijd omvatte problemen uit zes verschillende domeinen: \prbm{Maximal Satisfiability (Max-Sat)}, \prbm{Bin Packing}, \prbm{Personnel Scheduling}, \prbm{Flow Shop}, \prbm{Travelling Salesman Problem (TSP)} en het \prbm{Vehicle Routing Problem (VRP)}.
