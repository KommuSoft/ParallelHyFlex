...
\showgraph[width=\textwidth]{smallp}{De evolutie van oplossing bij makkelijke problemen}{smallp}
...
\subsection{De invloed van \emph{AILLA}}
...
\subsection{De invloed van de \emph{Zoekruimte} en \emph{Ervaring-set}}
