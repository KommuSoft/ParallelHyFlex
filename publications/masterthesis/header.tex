...
\newcommand{\baserefq}[3]{\textsc{\textup{\ref{#1:#2}}}}
...
\newcommand{\sfglab}[1]{\baselab{sfg}{#1}}
\newcommand{\sfgref}[1]{\baseref{sfg}{#1}{Deelfiguur}}
\newcommand{\tbllab}[1]{\baselab{tbl}{#1}}
\newcommand{\tblref}[1]{\baseref{tbl}{#1}{Tabel}}
\newcommand{\tblrefs}[1]{\baserefs{tbl}{#1}{Tabellen}}
...
\newcommand{\secrefq}[1]{\baserefq{sec}{#1}{Sectie}}
