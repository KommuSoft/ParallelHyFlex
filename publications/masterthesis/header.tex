\usepackage{amssymb,amsmath,slantsc,bbm,tikz,tocloft,etoolbox,hyphenat,pdfpages, amsthm,graphicx}
...
\newcommand{\baseref}[3]{\textsc{#3~\textup{\ref{#1:#2}}}}
