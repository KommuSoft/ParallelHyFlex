\usepackage{amssymb,amsmath,slantsc,bbm,tikz}
...
\newcommand{\baseref}[3]{\textsc{#3 \ref{#1:#2}}}
...
\newcommand{\true}{\mathbftxt{true}}
\newcommand{\fals}{\mathbftxt{false}}
\newcommand{\nult}{\mathbftxt{null}}
\newcommand{\idet}{\mathbftxt{id}}
\newcommand{\rslt}{\mathbftxt{resultaat}}
\newcommand{\sndr}{\mathbftxt{zender}}
\newcommand{\rcvr}{\mathbftxt{ontvanger}}
\newcommand{\msgt}{\mathbftxt{bericht}}
\newcommand{\bset}{\mathbftxt{base}}
\newcommand{\impt}{\mathbftxt{import}}
\newcommand{\owdt}{\mathbftxt{eigenData}}
...
\SetKwBlock{WhnRcv}{when received}{}
\SetKwBlock{Func}{function}{end}
