...
\prbm{Sat} is een \comp{NP-compleet} probleem en bijgevolg kan men elk probleem in \emph{NP} omzetten naar \prbm{Sat}. Door de prestaties van \prbm{Sat} te analyseren, analyseren we dus impliciet een grote set van problemen die allemaal omgezet kunnen worden.
